...
### 4.3ケース：display:noneを設定したのに、なぜページがまだカクつくのか
...
### 5.3ケース：なぜアニメーションがパワポのようにカクつくのか
