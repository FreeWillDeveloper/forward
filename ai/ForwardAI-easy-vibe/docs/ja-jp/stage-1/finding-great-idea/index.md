...
前章では、日常の経験、公開されている議論、プロダクトのレビューから、いくつもの手がかりを集めました。次に行うのは、すぐにコードを書くことではありません。手がかりを方向性として整理し、その中から検証する価値の高いものを選びます。

ある方向性に取り組む価値があるかどうかは、目新しく聞こえるかだけでは判断できません。問題がどのくらい頻繁に起こり、どれほど大きな影響があり、ユーザーが現在どのように対処し、そのために時間や費用を投じる意思があるかも確認する必要があります。

本章では、小明の物語を通して、これらの判断を具体的な場面に当てはめます。候補となる方向性を順に整理し、根拠があり、さらに調べる価値のあるプロダクトコンセプトをいくつか残します。次章では、ユーザーが本当に成し遂げたいことをさらに分析します。
...
**一人の一つの出来事から入り、横に切って縦に掘り、AI との対話で概念を磨き、五つの手順で検証してから着手する**
...
<StageAssignmentCard title="小さな困りごとをプロダクトのアイデアに変える">
  ...
  <p>最近経験した小さな困りごとから始めます。別に大きなテーマを考える必要はありません。</p>

  <ol>
    <li>その困りごとを一文で書きます。</li>
    <li>同じ問題に直面しそうな人を三つの層に分け、その中から最もよく理解している層を一つ選びます。</li>
    <li>その人がどのような状況で問題に直面し、現在はどう対処しているかを書きます。</li>
    <li>アイデアを言い換えます。誰のためのもので、どの仕事をよりよく進められるようにするのかを示します。</li>
  </ol>

  <p>書き終えたら友人一人に読んでもらい、内容をすぐ理解できるか確認します。</p>
