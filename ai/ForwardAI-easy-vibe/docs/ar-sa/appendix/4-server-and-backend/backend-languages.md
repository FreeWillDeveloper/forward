...
---
## 1. الدافع وراء يجب أن تتعرف على لغات الواجهة الخلفية
...
### 2.3 نموذج التزامن: تعريف وقياس طلبًا يمكن معالجته في وقت واحد
...
### 2.4 إدارة الذاكرة: تعريف وقياس المسؤول عن جمع القمامة
