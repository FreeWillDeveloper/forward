# مبادئ تصميم API: بروتوكول الاتصال بين الواجهة الأمامية والخلفية
...
## 0. سؤال أولاً: هل مررت بتعريف وقياس من هذه الكوابيس
...
### 2.1 REST مقابل RESTful: نظرة عامة على الفروق
...
### 6.1 الدافع وراء نحتاج التحكم في الإصدارات
