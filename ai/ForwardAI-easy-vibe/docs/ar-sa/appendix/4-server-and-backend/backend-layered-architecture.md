# مبادئ هندسة الواجهة الخلفية متعددة الطبقات
...
## 1. الدافع وراء نحتاج إلى الطبقات
...
### 6.1 تعريف وقياس يمكن لـ Controller كتابة منطق الأعمال
...
### 6.2 نظرة عامة على النموذج الفقير والنموذج الغني
...
### 6.3 نهج التعامل مع المعاملات عبر عدة Service
