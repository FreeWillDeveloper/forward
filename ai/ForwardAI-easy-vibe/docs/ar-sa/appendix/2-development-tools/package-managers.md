...
## 0. الدافع وراء ستستخدم مدير حزم حتماً
...
### 1.1 تعريف وقياس أين تُنزّل الحزم — السجل (Registry)
...
## 2. تثبيت حزمة — تعريف وقياس يحدث خلف الكواليس
...
### 4.1 الدافع وراء لا نُثبّت النسخة بالضبط
...
### 4.2 نظرة عامة على "جحيم التبعيات"
...
### 5.2 تعريف وقياس يجب رفع ملف القفل إلى Git
