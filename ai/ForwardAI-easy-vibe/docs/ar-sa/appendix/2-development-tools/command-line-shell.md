# مدخل سطر الأوامر وسكربتات Shell
...
## 0. البدء السريع: نهج تفتح الطرفية
...
### 0.2 الدافع وراء نتخلى عن الفأرة (Why CLI?)
...
## 1. تعريف المفاهيم: نظرة عامة على الطرفية (Definition)
...
### 2.2 الدافع وراء الفصل (القابلية للاستبدال)
