...
## 0. مقدمة: نظرة عامة على إطار العمل الأمامي
...
## 1. المشكلة الجوهرية: البيانات تغيرت، تعريف وقياس عن الواجهة
...
### 1.2 الدافع وراء عندما يتغير متغير JavaScript، لا تتحدث الواجهة تلقائيًا
...
### 1.3 تعريف وقياس إطار العمل خطوتان لبناء اتصال تلقائي
...
### 2.3 الدافع وراء Declarative أفضل من Imperative
...
## 3. نظام التفاعلية: نهج يعرف إطار العمل أن البيانات تغيرت

### 3.1 نظرة عامة على "التفاعلية"
...
## 5. تكلفة عمليات DOM: الدافع وراء يبذل إطار العمل كل هذا الجهد

### 5.1 نظرة عامة على عملية DOM
...
### 5.2 نهج يحل إطار العمل هذه المشكلة
