...
## 1. نظرة عامة على HTML و CSS و JavaScript
...
### 2.1 الدافع وراء نحتاج إلى HTML
...
### 2.5 نهج تتذكر كل وسوم HTML هذه
...
#### تعريف وقياس تفعل عندما ترى وسمًا لا تعرفه
...
### 3.5 نموذج الصندوق: الدافع وراء العرض لا يتطابق
...
### 3.6 Flexbox: نهج تجعل العناصر تترتب تلقائيًا
...
#### 3.7.1 نظرة عامة على معالجات CSS المسبقة
...
### 3.8 نهج تتذكر كل خصائص CSS هذه
...
#### تعريف وقياس تفعل عندما ترى خاصية لا تعرفها
...
### 4.1 الدافع وراء نحتاج إلى JavaScript
...
### 4.4 DOM: نهج يتعامل JavaScript مع الصفحة
...
#### الدافع وراء توجد أرقام إصدارات
...
#### الدافع وراء نحتاج إلى TypeScript
...
## 6. تعريف وقياس تفعل عندما ترى كودًا لا تعرفه
