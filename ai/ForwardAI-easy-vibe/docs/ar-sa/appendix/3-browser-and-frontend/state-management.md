...
## 1. الدافع وراء المكونات وإدارة الحالة
...
### 2.3 تدفق البيانات أحادي الاتجاه: الدافع وراء لا يمكن تعديل props مباشرة
...
## 5. دليل عملي: نهج تصمم إدارة الحالة
