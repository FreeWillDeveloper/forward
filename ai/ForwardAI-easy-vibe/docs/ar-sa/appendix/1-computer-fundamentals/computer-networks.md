# شبكات الحواسيب: من إدخال عنوان URL حتى عرض الصفحات
...
## 2. العملية الفعلية: تدفق استعلام DNS
...
### العملية الفعلية: تدفق الاستعلام الهرمي لـ DNS
...
## 4. العملية الفعلية: تدفق بروتوكول HTTP

### العملية الفعلية: تدفق بروتوكول HTTP
...
## 5. العملية الفعلية: تدفق عرض المتصفح

### العملية الفعلية: تدفق محرك عرض المتصفح
