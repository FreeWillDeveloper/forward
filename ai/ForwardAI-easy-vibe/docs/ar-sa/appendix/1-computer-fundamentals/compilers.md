...
|-----|------|---------|
| الفصل 1 | نظرة عامة على المترجم البرمجي | المترجم، خط أنابيب الترجمة |
...
### 5.1 التحليل الدلالي: التحقق من صحة المعنى
...
### 5.2 تحسين الكود: جعل البرنامج أسرع
