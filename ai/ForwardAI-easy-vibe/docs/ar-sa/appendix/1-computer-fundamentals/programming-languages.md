# مفاهيم لغات البرمجة: النماذج والتطور والاختيار
...
## 0. نظرة عامة على التواصل مع الحاسوب
...
تعمق في أنظمة الأنواع -> [مقدمة في أنظمة الأنواع](./type-systems) | [مبادئ التجميع](./compilers)
...
**الخطوات التالية**:
- [مبادئ التجميع](./compilers) - فهم عملية الترجمة
- [مقدمة في أنظمة الأنواع](./type-systems) - فهم أمان الأنواع
- [مقدمة في هياكل البيانات](./data-structures) - فهم تنظيم البيانات
- [مقدمة في الخوارزميات](./algorithm-thinking) - تعلم طرق حل المشكلات
