# مبادئ قواعد البيانات: الفهارس / المعاملات / تحسين الاستعلامات
::: tip 🎯 السؤال الجوهري
...
### 2.2 المفتاح الرئيسي (Primary Key): المعرف الفريد للبيانات
...
## 3. نهج تتحدث مع قاعدة البيانات مقدمة SQL وتطبيقها
...
## 4. الدافع وراء قواعد البيانات سريعة بهذا الشكل كشف أسرار الفهارس
...
## 5. المعاملات: نهج نضمن عدم فقدان أو إفساد البيانات
...
### 5.1 نظرة عامة على المعاملة (Transaction)
