...
## الخطوة 1: اختيار مخطط الجمع — تعريف وقياس نضع المسجّلات
...
## الخطوة 2: تصميم تنسيق البيانات — تعريف وقياس يجب أن يحتوي كل سجل
...
## الخطوة 3: النقل والتخزين المؤقت — نهج ننقل البيانات بأمان إلى الخادم
