# مبادئ التخزين الكائني وشبكات CDN
...
## 0. المقدمة: الدافع وراء يكون رفع وتنزيل الملفات "بطيئًا" جدًا
...
### 1.1 نظرة عامة على التخزين الكائني
...
#### التحكم في الوصول: تعريف وقياس يستطيع الوصول إلى "مستودعي
...
#### نظرة عامة على العودة إلى المصدر
...
### 5.1 الدافع وراء HTTPS مهم على CDN
