...
## 3. Nginx: الدافع وراء يستطيع تحمل ملايين الطلبات المتزامنة
...
## 4. نظرة عامة على بوابة API

### 4.1 الدافع وراء نحتاج إلى بوابة API
...
## 7. تحديد المعدل والانصهار: كيفية منع النظام تعريف وقياس الانهيار بسبب "طوفان حركة المرور
