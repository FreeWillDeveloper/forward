# مبادئ وكيل الذكاء الاصطناعي واستدعاء الأدوات
...
### 1.1 الدافع وراء لا يمكن لـ LLM تنفيذ العمليات مباشرة
...
## 2. التحدي الأساسي: نهج ننجز المهام المعقدة
