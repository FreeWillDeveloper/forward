...
## 0. مقدمة: الدافع وراء ينسى النموذج أثناء المحادثة، وتزداد التكلفة
...
## 1. نظرة عامة على هندسة السياق (التعريف + السيناريوهات)
...
### 2.1 تعريف وقياس علمتنا عمليات إعادة الهيكلة الأربع
...
### 2.2 نهج تشبه "ذاكرة" الذكاء الاصطناعي
...
## 3. الخطوة الأولى: فهم التكلفة - أين يذهب كل قرش تعريف وقياس أموالك

### 3.1 الدافع وراء ننظر إلى التكلفة أولاً
...
### 3.2 نظرة عامة على KV Cache (إعادة استخدام البادئة)
...
### 4.1 الدافع وراء يسبب "الداخل أولاً يخرج أولاً" مشاكل
...
### 4.2 "فقدان الذاكرة الوسطى" - الدافع وراء لا يرى الذكاء الاصطناعي المعلومات الأساسية دائمًا
...
## 5. الخطوة الثالثة: الاحتفاظ الانتقائي - نهج نثبّت" المعلومات الأساسية

بما أن "الداخل أولاً يخرج أولاً" غير موثوق، ماذا نفعل إذن؟
جواب Manus هو: **بناء "نظام تصنيف المعلومات"**.

### 5.1 الدافع وراء نصنف المعلومات
...
### 6.1 الدافع وراء "السبورة الصغيرة" غير كافية
...
### 8.2 الدافع وراء هذا التصميم هو الأقوى
