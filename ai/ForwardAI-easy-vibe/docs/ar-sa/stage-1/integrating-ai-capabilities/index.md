...
**MiniMax** هي شركة صينية للذكاء الاصطناعي، تكرس جهودها للبحث وتطوير تقنيات الذكاء الاصطناعي العام. أطلقت MiniMax تباعًا سلسلتي النماذج اللغوية الكبيرة MiniMax-M3 و MiniMax-M2.7، وقد حققتا أداءً ممتازًا في العديد من اختبارات المعايير، وتتميزان بنسبة أداء إلى تكلفة عالية جدًا.

**الخصائص الرئيسية لسلسلة MiniMax:**

- **سياق طويل جدًا**: يدعم M3 نافذة سياق تصل إلى 1,000,000 رمز (tokens)، بينما يدعم M2.7 ما يصل إلى 204,800 رمز، مما يجعله مناسبًا لمعالجة المستندات الطويلة والمحادثات متعددة الأدوار
...
- **النماذج المتاحة**:
  - `MiniMax-M3`: أحدث نموذج رائد، يدعم سياقًا بحجم 1,000,000 ومخرجات تصل إلى 128K، كما يدعم إدخال النصوص والصور والفيديو
  - `MiniMax-M2.7`: النموذج الرائد السابق، لا يزال متاحًا
...
3. **اسم النموذج**: غيّره إلى `MiniMax-M3` (الرائد الجديد) أو `MiniMax-M2.7` أو `MiniMax-M2.7-highspeed`
