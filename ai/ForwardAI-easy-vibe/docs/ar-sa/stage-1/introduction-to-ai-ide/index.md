...
## كيف تتعلم بنشاط بمساعدة الذكاء الاصطناعي

::: tip 💡 أهم قاعدة للتعلم: عندما تواجه سؤالاً، اسأل الذكاء الاصطناعي أولاً
من الآن فصاعداً، اجعل الذكاء الاصطناعي **أول جهة تطلب منها المساعدة**. سواء لم تفهم مفهوماً، أو لم تعرف تثبيت أداة أو كتابة أمر، أو ظهر خطأ في البرنامج، أو لم تعرف الخطوة التالية، **اسأل الذكاء الاصطناعي أولاً ثم جرّب الإجابة بنفسك**.

يمكنك أن تبدأ بالذكاء الاصطناعي في الأسئلة التي كنت ستطرحها على المدرس أو زميل أو مجموعة دردشة. فهو يجيب بسرعة، ويتيح المتابعة، ويستطيع استخدام رسالة الخطأ وسياق المشروع لاقتراح الخطوة التالية. لا تنتظر حتى تبقى عالقاً مدة طويلة، ولا تستخدمه فقط عندما تريد منه كتابة الشيفرة.

**التعلم الأصيل بالذكاء الاصطناعي ليس مجرد إنجاز المهمة به؛ بل إشراكه في رحلة التعلم كلها: تسأل عند ظهور المشكلة، وتجرّب الإجابة، ثم تسأل من جديد عندما تظهر نتيجة أو مشكلة أخرى.**
:::

### دورة التعلم الأصيل بالذكاء الاصطناعي

التعلم النشط بالذكاء الاصطناعي لا يعني تسليمه المهمة وانتظار النتيجة. إنه يختصر وقت البحث عن الإجابة كي تقضي وقتاً أطول في **التجربة والتحقق والفهم**. استخدم هذه الدورة في كل فصل:

```mermaid
flowchart LR
  A["① تظهر مشكلة<br/>اشرح الهدف وما حدث"] --> B["② اسأل AI فوراً<br/>أرفق السياق"]
  B --> C["③ جرّب بنفسك<br/>طبّق الاقتراح"]
  C --> D{"هل النتيجة كما توقعت؟"}
  D -- "ليس بعد" --> E["④ أرسل النتيجة أو<br/>الخطأ الكامل إلى AI"]
  E --> B
  D -- "نعم" --> F["⑤ اشرح بكلماتك<br/>لماذا نجحت الطريقة"]
  F --> G["حوّلها إلى مهارة<br/>تستخدمها في مشكلة جديدة"]
```

### أسئلة شائعة يمكنك طرحها مباشرة

| ما الذي تواجهه | ما يمكنك قوله للذكاء الاصطناعي |
| --- | --- |
| **لا تفهم مفهوماً** | «ليست لدي خلفية برمجية. اشرح لي API بتشبيه من الحياة اليومية، ثم أعطني أصغر مثال.» |
| **لا تعرف تثبيت البيئة** | «أستخدم macOS وأريد تشغيل هذا المشروع. تحقق أولاً من المتطلبات، ثم أرشدني خطوة واحدة في كل مرة واشرح فائدة كل خطوة.» |
| **يظهر خطأ عند تنفيذ أمر** | «هذا هو الأمر والخطأ الكامل. حدّد السبب الأكثر احتمالاً أولاً، ثم أعطني أصغر تعديل. إن لم تكفِ المعلومات فأخبرني بما تحتاجه.» |
| **لا تعرف ما الخطوة التالية** | «هدفي صنع لعبة Snake وقد ظهرت شاشة اللعبة. أخبرني بأصغر خطوة تالية وبمعيار اكتمالها.» |
| **لا تفهم الشيفرة التي كتبها AI** | «لا تعدّل المزيد من الشيفرة الآن. اشرح التعديل الأخير حسب الوحدات، وما المشكلة التي يحلها كل جزء.» |
| **تحتار بين أكثر من خيار** | «أنا مبتدئ وأريد نسخة قابلة للتشغيل بسرعة. قارن بين A وB وفق هذين الشرطين ثم أوصِ بخيار واحد بوضوح.» |
| **النتيجة ليست كما توقعت** | «أردت الصفحة بهذا الشكل: …؛ لكنها الآن بهذا الشكل: …. قارن الفرق وأصلح أولاً أوضح نقطة فقط.» |

::: info قالب عام للسؤال
**هدفي هو …؛ وصلت حالياً إلى …؛ جرّبت …؛ النتيجة الفعلية أو الخطأ الكامل هو …؛ اشرح السبب أولاً ثم أخبرني بأصغر خطوة تالية.**

كلما كانت المعلومات محددة أصبحت الإجابة أنسب. من الطبيعي ألا تحل الإجابة الأولى المشكلة؛ أرسل النتيجة الجديدة مجدداً، فهذه المتابعة جزء من التعلم الأصيل بالذكاء الاصطناعي.
:::
...
<StageAssignmentCard title="أنشئ لعبتك الخاصة باستخدام بيئة تطوير مدعومة بالذكاء الاصطناعي">
