...
<StageAssignmentCard title="أكمل أول مجموعة من الألعاب الصغيرة المبنية للذكاء الاصطناعي">
...
تخيل صفحة الويب كمنزل. ثلاثة أنواع من "الأكواد" كل منها يتولى شيئًا واحدًا:

- **HTML**: يحدد **ما يوجد** على الصفحة — مثل رسم مخطط المنزل أولاً
- **CSS**: يحدد **كيف يبدو** — مثل طلاء الجدران وترتيب الأثاث
- **JavaScript**: يحدد **كيف يتفاعل** — مثل مفتاح الإضاءة: اضغط فيضيء المصباح

### كيف يتحول الكود إلى صفحة؟

المتصفح **يبني الهيكل بـ HTML، ويزين بـ CSS، ويشغّل الكهرباء بـ JavaScript** — ثلاث خطوات فتحصل على الصفحة.

### إذن ما هي React و Vue؟

إنها **"أدوات جاهزة" لبناء الصفحات المعقدة** — أسرع وأكثر موثوقية. لا تحتاج إلى تعلمها، فقط اعرف أنها أدوات مساعدة.

### في Vibe Coding

**لا تكتب أكوادًا، فقط صف ما تريد.** تحدث مع الذكاء الاصطناعي بلغة طبيعية، على سبيل المثال:
...
```
"يوجد خطأ في الكود، أصلحه."
"لا تعطِني جزءًا من الكود؛ أعطني النسخة الكاملة بعد التعديل."
"ما زال الكود به مشكلة."
"عدّل مرة أخرى وأعطني الكود المصحح كاملاً."
"كان يعمل قبل قليل، فلماذا لا يعمل الآن؟"
"لم تفهم ما أقصده. لا تغيّر الكود الأصلي."
"لا تضف أي أدوات تصحيح."
"لا تنفذ شيئًا لم أطلبه."
"أين الميزة التي طلبت منك تنفيذها؟"
"أريد دالة واحدة فقط."
"قلت لك أن ترجع إلى الكود السابق."
"لا تضف تعليقات غير ضرورية."
"لا تغيّر المنطق الأساسي للكود الأصلي."
"عدّل الكود بناءً على الكود الموجود لدي."
"لا تغيّر أسماء المتغيرات!"
"لا تغيّر أسماء الدوال الأصلية!"
"لا تعبث بالمتغيرات."
"لا تضف وظائف إضافية."
"لا تنشئ هيكلاً فقط؛ أنشئ الكود الكامل."
```
