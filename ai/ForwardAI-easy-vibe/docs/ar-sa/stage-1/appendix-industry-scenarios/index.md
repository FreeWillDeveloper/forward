---
title: 'مرجع سيناريوهات تطبيق الذكاء الاصطناعي (B2B و B2C)'
description: 'يلخص هذا المستند تطبيقات نماذج LLM في سيناريوهات الشركات B2B وسيناريوهات الاستهلاك B2C. يغطي B2B 19 صناعة تشمل التصنيع وخدمة العملاء والتعليم والرعاية الصحية والتمويل؛ ويغطي B2C 16 سيناريو استهلاكي تشمل نمط الحياة والرفقة العاطفية والترفيه والنمو الشخصي، مما يوفر مرجعاً شاملاً لمطوري تطبيقات الذكاء الاصطناعي.'
---
...
// ---- C 端场景变量 ----
const cDuration = 'حوالي <strong>4 ساعات</strong>'
...
# مرجع سيناريوهات تطبيق الذكاء الاصطناعي (B2B و B2C)

<Tabs>
<TabItem label="B2B صناعي">
...
<TabItem label="B2C استهلاكي">

## مقدمة الفصل

<ChapterIntroduction :duration="cDuration" :tags="['تطبيقات C-end', 'نمط الحياة', 'التجربة العاطفية', 'خلق الأجواء']" coreOutput="اكتشاف 15+ إلهامًا لسيناريوهات الحياة" expectedOutput="إيجاد اتجاه منتج يلمس المستخدمين">
...
<el-card shadow="hover" style="margin-top: 16px; margin-bottom: 24px; border-left: 5px solid #ec4899;">
  ...
  <div v-if="cRecommendationTopics.length > 0" style="margin-top: 16px;">
    <div style="font-weight: 600; margin-bottom: 12px; color: #ec4899;">
      السيناريوهات الموصى بك لـ {{ cCurrentSelection.vibe }} × {{ cCurrentSelection.feeling }} :
    </div>
