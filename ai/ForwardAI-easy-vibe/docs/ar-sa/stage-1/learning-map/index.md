...
لا تعني هذه التغييرات أن الشركات تطلب المزيد من المهندسين فحسب؛ بل يتغير دور من يكتبون البرمجيات، ويُفتح في الوقت نفسه مدخل جديد لمن لا يكتبونها بعد.

#### لمن يكتبون البرمجيات بالفعل: يُعاد تعريف دور المهندس
...
#### للمبتدئين الذين لا يكتبون البرمجيات: فُتح باب جديد

خفض الذكاء الاصطناعي أيضًا حاجز بناء المنتجات بدرجة كبيرة.

- **لا حاجة إلى دراسة البرمجة سنوات قبل البدء.** يمكن وصف المطلوب بلغة طبيعية وطلب إنشاء الكود والواجهة وحل الأخطاء أثناء بناء شيء يعمل.
- **قد تكون خبرة المجال أندر من مهارة البرمجة.** يفهم المعلمون والأطباء والمحامون وفرق المبيعات والتشغيل المستخدمين والعمليات الحقيقية، وهذه المعرفة أساس المنتج الجيد.
- **يمكن أن تنخفض المسافة بين الفكرة والمنتج إلى أسابيع أو أيام.** يمكن تحويل مشكلة مألوفة إلى أداة صغيرة واختبار قيمتها مع مستخدمين حقيقيين.

لذلك تخدم الدورة المهندسين الراغبين في توسيع نطاقهم، والمبتدئين الذين يملكون فكرة أو خبرة في مجال ما.
