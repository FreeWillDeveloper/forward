...
::: info 💡 ملاحظة حول الأدوات
تتغير واجهات بيئات AI IDE والنماذج المتاحة وحدود الاستخدام باستمرار. اختر أداة يمكنك استخدامها بثبات؛ فمسار وصف المتطلبات والتوليد والفحص والتعديل في هذا الفصل لا يعتمد على علامة تجارية بعينها. وعند الحاجة إلى أداة برمجة عبر سطر الأوامر، راجع [أدوات AI CLI الحديثة](../../stage-2/backend/modern-cli/).
:::
