...
description: '面向零基礎讀者的 Jobs to Be Done 入門文章。理解使用者不是在買功能，而是在特定場景裡"雇用"你的產品完成進展，並學會用 JTBD 拆解產品方向、訪談問題與 AI 提示詞。'
---
...
<figure class="field-figure">
  <a href="https://commons.wikimedia.org/wiki/File:Mapa_de_viaje_de_clientes.png" target="_blank" rel="noreferrer">
    <img src="/images/product-discovery/jtbd/customer-journey-map.png" alt="一張顧客旅程圖，按階段記錄使用者需要、活動、使用物、感受和產品機會" loading="lazy" />
  </a>
...
<figure class="field-figure">
  <a href="https://commons.wikimedia.org/wiki/File:Taking_Notes.JPG" target="_blank" rel="noreferrer">
    <img src="/images/product-discovery/jtbd/meeting-note-taking.jpg" alt="一場真實會議中，參與者同時使用電腦和紙筆做記錄" loading="lazy" />
  </a>
...
<figure class="field-figure field-figure--narrow">
  <a href="https://commons.wikimedia.org/wiki/File:Scrum_task_board.jpg" target="_blank" rel="noreferrer">
    <img src="/images/product-discovery/jtbd/physical-task-board.jpg" alt="辦公室中的實體任務看板，便利貼在待辦、進行中和測試等欄目間移動" loading="lazy" />
  </a>
...
<figure class="field-figure">
  <a href="https://commons.wikimedia.org/wiki/File:Touch_on_Clamshell_Devices.jpg" target="_blank" rel="noreferrer">
    <img src="/images/product-discovery/jtbd/intel-context-observation.jpg" alt="Intel 使用者體驗研究中，一名參與者直接用手觸摸筆記本螢幕" loading="lazy" />
  </a>
...
<StageAssignmentCard title="寫清使用者真正想完成的事">
