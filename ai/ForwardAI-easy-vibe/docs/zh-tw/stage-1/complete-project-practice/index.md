---
title: '完整專案實作：從想法到作品'
description: '把已經接入 AI 的原型完整用一遍，請別人來試試，再把發現的問題改好。'
---
...
const duration = '約 <strong>2～3 天</strong>'
...
<ChapterIntroduction :duration="duration" :tags="['完整使用', '產品體驗', '使用者試用', '作品展示']" coreOutput="1 個別人不需要指導也能使用的 AI 產品" expectedOutput="經過真實試用和修改的 Web 作品">
...
<div style="margin: 50px 0;">
  <ClientOnly>
    <StepBar :active="0" :items="[
      { title: '自己用一遍', description: '從開始走到結果' },
      { title: '把卡點補好', description: '等待、結果與失敗' },
      { title: '請別人來試', description: '先觀察，不代操作' },
      { title: '整理並分享', description: '讓別人看懂作品' }
    ]" />
  </ClientOnly>
</div>
...
![商品內容生成過程中的等待狀態](../../../zh-cn/stage-1/building-prototype/images/index-2026-01-14-15-50-05.webp)
...
![圖片理解和文案生成接入後的結果頁面](../../../zh-cn/stage-1/integrating-ai-capabilities/images/index-2026-01-20-15-35-41.webp)
...
你可以繼續完成貫穿本章的電商內容工作台，也可以把同一套方法用到自己的場景，例如會議整理、有聲內容、學習輔助或行業小工具。[AI 應用場景參考](../appendix-industry-scenarios/index.md)可以幫助你擴展方向。
...
<StageAssignmentCard title="完成併發布你的第一階段作品">
...
<RelatedArticlesSection
  title="繼續進階"
  description="完成 Stage 1 後，可以繼續學習下面的工程化內容。"
