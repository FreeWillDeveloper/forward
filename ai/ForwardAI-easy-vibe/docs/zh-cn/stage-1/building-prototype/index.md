...
在前面的章节中，我们学习了如何找到好点子、验证真实需求——从用户需求出发，找到有人愿意买单的方向。但找到方向只是第一步，<strong>真正考验产品经理的是：如何把模糊的需求变成能用的产品。</strong>
...
前面我们学习了如何找到<strong>有人愿意买单的好点子</strong>，并用用户访谈验证了真实需求，但找到方向只是开始。真正做产品时，你会发现：<strong>知道"做什么"和知道"怎么做"之间，还有巨大的鸿沟。</strong>
