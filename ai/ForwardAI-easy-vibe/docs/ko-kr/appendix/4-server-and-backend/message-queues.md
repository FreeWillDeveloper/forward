...
## 3. 핵심 문제 1: 시스템을디커플링하여 "한 곳이 흔들리면 전체가 무너지는" 상황을 피 접근법
...
## 4. 핵심 문제 2: 피크를 깎고 골짜기를 채워(Peak Shaving), 트래픽 급증에 대응 접근법
### 4.1 플래시 세일 시나리오: 10만 QPS를안정적으로 처리 접근법
