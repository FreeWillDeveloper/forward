...
타입 시스템에 대해 더 깊이 알고 싶다면 → [타입 시스템 서론](./type-systems) | [컴파일러 원리](./compilers)
...
**다음 학습**:
- [컴파일러 원리](./compilers) - 컴파일 과정과 코드 최적화에 대한 깊은 이해
- [타입 시스템 서론](./type-systems) - 타입 시스템과 타입 안전성에 대한 깊은 이해
- [자료구조 서론](./data-structures) - 데이터의 조직 방식 이해
- [알고리즘 서론](./algorithm-thinking) - 문제 해결 방법 학습
