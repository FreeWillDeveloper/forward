...
## 0. 서론: 왜 대화가 길어질수록 점점 더 많은 것을 잊고, 점점 더 비싸질까 동기
...
## 7. 다섯 번째 단계: 압축 - "작은 칠판 더 빽빽하게 최적화 접근법
