...
### 2.2.1 이미지 분류: "이것은 어떤 이미지인가 "에 답하기 선정 기준
...
### 2.2.2 이미지 인식 및 속성 인식: "이것은 누구인가 / 이것은 어떤 인스턴스인가 "에 답하기 선정 기준
...
### 2.7.1 이미지 캡셔닝과 시각 질의응답: "이미지를 보고 통신"에서 "이미지를 보고 추론하기"까지
...
### 4.4.1 텍스트 음성 변환 (TTS): 기계가 "자연스럽게 통신" 시작하다
...
### 5.5.1 구동 및 표현: 스크립트 / 음성에서 "통신하고 표정 짓는 사람"으로
