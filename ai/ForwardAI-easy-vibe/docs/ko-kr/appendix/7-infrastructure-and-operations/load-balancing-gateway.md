...
## 2. 로드 밸런싱이란 개요
### 2.1 4계층 로드 밸런싱(L4): IP 주소와 포트만 본다
...
### 2.2 7계층 로드 밸런싱(L7): 빌드 산출물 내용물 검사
...
## 4. 핵심 질문 2: "기존 사용자 세션"이 항상 같은 "백엔드 인스턴스"을 찾도록 보장하려면

### 4.1 세션 지속성: "기존 사용자 세션"이 항상 같은 "백엔드 인스턴스"을 찾도록
