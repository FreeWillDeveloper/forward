...
## 2. 리버스 프록시란 개요
### 2.1 포워드 프록시 vs 리버스 프록시: :: tip 용어 설명 비교
...
## 3. Nginx: 왜 수백만 동시 접속을 감당할 수 있는가 동기
...
## 5. 게이트웨이 실전: 완전한 게이트웨이 아키텍처는 어떻게 구축하는가 접근법
...
## 6. 게이트웨이 보안: 시스템 현관문을 어떻게 지킬 접근법
...
## 7. 속도 제한과 서킷 브레이커: 시스템이 "트래픽 홍수"에 쓸려가는 것을방지 접근법
