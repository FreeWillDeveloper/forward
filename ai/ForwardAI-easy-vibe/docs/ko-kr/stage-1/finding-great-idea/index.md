...
앞 장에서는 일상의 경험, 공개 토론, 제품 평가에서 원시 단서를 모았습니다. 다음 단계는 바로 코드를 쓰는 것이 아니라, 이 단서들을 가능한 방향으로 정리한 뒤 그중 검증할 가치가 더 큰 하나를 고르는 것입니다.

어떤 방향이 새롭게 들린다는 이유만으로 만들 가치가 생기지는 않습니다. 문제가 얼마나 자주 발생하는지, 영향이 얼마나 뚜렷한지, 사용자는 지금 어떻게 해결하는지, 이미 시간이나 비용을 들이고 있는지도 살펴야 합니다.

이 장에서는 샤오밍의 이야기를 따라 이런 판단을 구체적인 상황에 놓아 봅니다. 후보 방향을 차근차근 정리하고, 증거가 뒷받침하며 더 알아볼 가치가 있는 제품 개념 몇 가지를 남깁니다. 다음 장에서는 사용자가 실제로 끝내려는 일을 더 깊이 분석합니다.
...
<StageAssignmentCard title="작은 불편 하나를 제품 아이디어로 바꾸기">
  ...
  <p>최근에 겪은 작은 불편 하나에서 시작하세요. 거창한 주제를 새로 지어낼 필요는 없습니다.</p>

  <ol>
    <li>그 불편을 한 문장으로 적습니다.</li>
    <li>그 일을 겪을 법한 사람 세 부류를 나열하고, 가장 잘 아는 한 부류를 고릅니다.</li>
    <li>그 사람이 언제 문제를 겪고 지금은 어떻게 해결하는지 적습니다.</li>
    <li>아이디어를 다시 말합니다. 누구를 위한 것이며, 어떤 일을 더 잘하도록 돕습니까?</li>
  </ol>

  <p>완성한 뒤 친구 한 명에게 보여 주고, 내용을 바로 이해하는지 확인하세요.</p>
