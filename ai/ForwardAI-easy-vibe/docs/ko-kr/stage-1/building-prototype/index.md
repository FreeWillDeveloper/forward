...
::: info 💡 도구 안내
AI IDE의 화면, 사용 가능한 모델, 사용량 한도는 계속 바뀝니다. 현재 안정적으로 사용할 수 있는 도구를 선택하면 됩니다. 이 장에서 다루는 요구사항 설명, 생성, 확인, 수정 과정은 특정 브랜드에 의존하지 않습니다. 명령줄 코딩 도구가 필요하다면 [현대 AI CLI 도구](../../stage-2/backend/modern-cli/)를 참고하세요.
:::
