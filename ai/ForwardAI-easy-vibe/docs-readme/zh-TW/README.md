...
<img src="../../assets/banner.png" alt="Easy-Vibe — 想到，就做到。從第一個想法到真正可用的產品。" width="100%">

<p align="center" style="font-size: 1.2em; color: #666; margin: 20px 0;">
  從零開始學習 AI 程式開發，在真實交付中把想法做成產品。<br>
...
<p align="center" style="font-size: 1.05em; color: #666; margin: 16px 0;">
  ...
  從產品原型、全端開發到 AI 原生工作流程，核心教學現已完整支援 10 種語言。歡迎世界各地的朋友一起創造！<br>
